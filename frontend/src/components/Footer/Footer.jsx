    ...
    <div className='footer' id='footer'>
      <div className="footer-content">
        <div className="footer-content-left">
          <img className='logo' src={assets.logo} alt="" loading="lazy" decoding="async" />
        ...
        <div className="footer-content-right">
          ...
          <div className="footer-social-icons">
            <a href="https://www.instagram.com/whatashawarma/" target="_blank" rel="noopener noreferrer"> <img src={assets.instagram_icon} alt="" loading="lazy" decoding="async" /></a>
